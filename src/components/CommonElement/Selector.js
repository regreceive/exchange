          ...
          <div key={key} onClick={e => props.selectItem(e, item.symbol, item.address)} className="token-item">
            <div>
              ...
              <span className="item-name">
                <span className="font-w-b">{item.symbol}</span>
                <span className="show-for-large token-name"> - {item.name}</span>
              </span>
              {item.isNotSupport && (
          ...
          <div className="focus-item d-flex">
            <div>
              ...
              <div>
                ...
                <div>
                  <span className="token-balance" title={toT(focusItem.balance)}>
                    {roundingNumber(toT(focusItem.balance, focusItem.decimal))}
                  </span>
            ...
            <div>
              <i className={'k k-angle white ' + (props.open ? 'up' : 'down')} />
            </div>
          </div>
        </DropdownTrigger>
        <DropdownContent>
          <div className="select-item">
            <div className="search-item">
              <input
                ...
                placeholder={props.translate('search') || 'Search'}
                onChange={e => props.changeWord(e)}
                type="text"
              />
            </div>
            <div className="list-item custom-scroll">{getListToken()}</div>
          </div>
        </DropdownContent>
      </Dropdown>
    </div>
