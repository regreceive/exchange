...
export default class TradingView extends React.Component {
  ...
  componentDidMount() {
    ...
    widget.onChartReady(() => {
      this.createButton(widget, {
        content: this.props.translate('trading_view.sell') || 'Sell',
        value: 'sell',
        title: this.props.translate('trading_view.sell_price') || 'Sell price',
      });
      this.createButton(widget, {
        content: this.props.translate('trading_view.buy') || 'Buy',
        value: 'buy',
        title: this.props.translate('trading_view.buy_price') || 'Buy price',
      });
      this.createButton(widget, {
        content: this.props.translate('trading_view.mid') || 'Mid',
        value: 'mid',
        title: this.props.translate('trading_view.mid_price') || 'Mid price',
      });
    });
    //	});
  }
  ...
  render() {
    ...
    return (
      <div
        style={{ height: 600, padding: 20, marginTop: 10 }}
