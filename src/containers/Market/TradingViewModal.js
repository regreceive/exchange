  ...
  content = () => {
    ...
    return (
      <div className="trading-view-modal">
        <a className="x" onClick={e => this.closeModal(e)}>
          &times;
        </a>
        {currency === 'USD' && (
          <p className="trading-title">
            {this.props.translate('market.support_eth_only') ||
              'Now support only pairs with ETH, not support pairs with USD yet.'}
          </p>
        )}
