...
export default class TermAndServices extends React.Component {
  ...
  content = () => {
    return (
      <div>
        ...
        <a class="x" onClick={this.onRequestClose}>
          &times;
        </a>
        <div class="content">
          <div class="row">
    ...
    return (
      <div class="term-page">
        <div class="term-content">
          <div class="body">
            <p>
              {this.props.translate('terms.content') ||
            ...
            <div class="gap" />
            <h3 class="warning">{this.props.translate('terms.use_testnet') || 'USE ONLY TESTNET ACCOUNTS!!!'}</h3>
            <h3 class="warning">{this.props.translate('terms.use_real') || 'DO NOT USE REAL ETHEREUM ACCOUNTS!!!'}</h3>
          </div>
        </div>
      </div>
    );
  ...
  render() {
    var src = this.props.termAgree
      ? require('../../../assets/img/checkmark-selected.png')
    ...
    return (
      <div className="term-services">
        ...
        <span className="term-text">
          <span className="cur-pointer">{this.props.translate('terms.accept') || 'Accept'}</span>
        ...
        <div className="landing-page__content-btn-container">
          <button className="landing-page__content-btn button" onClick={this.props.onClick}>
